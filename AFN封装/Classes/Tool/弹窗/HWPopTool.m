    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if(animated){
          ...
          //  containerView.layer.shouldRasterize = YES;
            ...
            [UIView animateWithDuration:kFadeInAnimationDuration delay:0 usingSpringWithDamping:1  initialSpringVelocity:20 options:UIViewAnimationOptionCurveLinear animations:^{
